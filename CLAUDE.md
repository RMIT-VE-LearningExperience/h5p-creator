...
FastAPI + Claude/OpenAI service that converts Word documents, PDFs, and PowerPoints into H5P activity packages ready for RMIT's H5P platform (h5p.rmit.edu.au).
...
app/
  ...
  services/
    ...
    ai_processor.py          — Build prompts, call Claude/OpenAI, return ProcessorResult
