...
async function previewVideoSlot(card) {
  ...
  try {
    ...
    statusEl.textContent = payload.description_fallback
      ? "Preview ready. VAL was unavailable, so the description uses the video title."
      : "Preview ready — push when you're happy with it.";
  } catch (err) {
